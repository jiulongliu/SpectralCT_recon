function X=ReconTVmultibins(y0,mu0,lambda,GPU)
[nd,nv0,nbin]=size(y0);
% clear;clc;close all;
% %Xr=[];
% addpath([pwd '\Bregman050412']);
% addpath([pwd '\framelet050712']);
% addpath([pwd '\CT-fp']);
% addpath([pwd '\NLTV']);
%%%%%%%%%%system matrix%%%%%%%%%%%%%
% nx=1500;ny=nx;n=nx*ny;
% dx=350/nx;
% nv=100;
% SO=1000;OD=500;
% nd=2000;dy_det=(0.388*1024)/nd;

%nx=3154;ny=300;n=nx*ny;
% nx=1300;ny=1300;n=nx*ny;
% dx=0.01;
...
'cg_iter',15,'cg_tol',1e-4,'JtJ',JtJ,'Wxs',Wxs,'Wtxs',Wtxs,'wps',wps,'Sxs',Sxs);
